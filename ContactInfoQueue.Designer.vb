...
Partial Class ContactInfoQueue
    ...
    Private Sub InitializeComponent()
        ...
        Label2.TabIndex = 15
        Label2.Text = "Queue Up for a TourDrone"
        ...
        Label1.TabIndex = 16
        Label1.Text = "Enter your contact info to be notified when you are next in queue to pilot the TourDrone"
        ...
        Button1.Location = New Point(268, 460)
